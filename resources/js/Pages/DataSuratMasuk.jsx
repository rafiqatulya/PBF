...
export default function DataSuratMasuk({ auth, surat_masuk, search_key, page, all_surat_masuk_count }) {
    ...
    function handleSubmit(e) {
        e.preventDefault()
        router.get('/data-surat-masuk', values)
    }
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        {all_surat_masuk_count > 10 && <div className='flex'>
                            <button onClick={prevPage} className={ 'p-2 rounded-r-md border ' + (page < Math.floor(all_surat_masuk_count / 10) || page == 1 ? 'hidden' : '')}>
                                Previous
                            </button>
                            <button onClick={nextPage} className={ 'p-2 rounded-r-md border ' + (page > Math.floor(all_surat_masuk_count / 10)  ? 'hidden' : '')}>
                                Next
                            </button>
                        </div>}
                    </div>

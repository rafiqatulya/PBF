...
export default function LaporanSuratMasuk({ auth, surat_masuk, search_key, page, all_surat_masuk_count, entriesShown, start_date, end_date }) {
    ...
    function handleSubmit(e) {
        e.preventDefault()
        router.get('/laporan-surat-masuk', values)
    }
    ...
    function handlePrint(e) {
        e.preventDefault()
        const url = '/laporan-surat-masuk/export';
            ...
            >
                ...
                >
                    ...
                    >
                                    ...
                                    <tr key={item.id}>
                                        ...
                                        <td className='p-3 border border-[#777777]'>
                                            <div className='flex items-center justify-center'>
                                                {/* {item.status === 'Terkirim' ?
                                                    <button className='mx-auto' onClick={() => router.post('/tindak-lanjuti-surat-masuk', { 'id': item.id })}>
                                        ...
                                        <td className='p-3 border border-[#777777]'>
                                            <div className='flex items-center justify-center gap-3'>
                                                ...
                                                {/* <button onClick={() => router.put('/upload-surat-masuk', {'id': item.id})}>
                                            ...
                                            <button onClick={() => router.delete('/upload-surat-masuk/' + item.id)}>
                        ...
                        >
                            <p className='font-montserrat'>Showing {surat_masuk.length} of {all_surat_masuk_count} entries</p>
                            {all_surat_masuk_count > entriesShown && <div className='flex'>{ }
                                <button onClick={prevPage} className={'p-2 rounded-r-md border ' + (page < Math.floor(all_surat_masuk_count / entriesShown) || page == 1 ? 'hidden' : '')}>
                                    Previous
                                </button>
                                <button onClick={nextPage} className={'p-2 rounded-r-md border ' + (page > Math.floor(all_surat_masuk_count / entriesShown) ? 'hidden' : '')}>
                                    Next
                                </button>
                            </div>}
                        </div>
